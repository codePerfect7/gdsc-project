...
const DisplayPosts = ({ post, error, session, userid }: { post: any, error: string | null, session: Session, userid: string }) => {
  ...
  return (
    <div className="w-3/4 bg-slate-600/50 mt-8 rounded-2xl animate-in pt-4 ">
